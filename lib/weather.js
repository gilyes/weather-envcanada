...
function parseWeatherXml(xml, callback) {
    xml2js.parseString(xml, function(error, json) {
        ...
        var weather = {
            ...
            warnings: [],
            forecasts: [],
            cloudPopTextSummary: 'N/A',
            popTextSummary: 'N/A',
            relativeHumidityPercent: 0,
            windTextSummary: 'N/A',
            weatherTextSummary: 'N/A'
        };
        ...
        if (weatherRoot.forecastGroup[0].forecast) {
            weatherRoot.forecastGroup[0].forecast.forEach(function(forecast) {
                ...
                weather.forecasts.push({
                    ...
                    cloudPopTextSummary: forecast.cloudPrecip[0].textSummary[0],
                    popTextSummary: forecast.precipitation[0].textSummary[0],
                    relativeHumidityPercent: forecast.relativeHumidity[0]._,
                    windTextSummary: (forecast.winds[0].hasOwnProperty('textSummary')) ? forecast.winds[0].textSummary[0] : '',
                    weatherTextSummary: forecast.textSummary[0]
                });
            });
        }
